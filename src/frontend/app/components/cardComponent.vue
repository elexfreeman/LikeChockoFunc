  ...
  <div class="cart_component">
    <div class="cart_menu">
      <div class="columns">
        ...
        <div class="column col-4 col-sm-2 text-right cart-col">
          <!--  <img
            v-if="cart.products.length > 0"
            v-on:click="onShowCart"
            class="cart-ico"
            src="/img/cart-ico.png"
          />-->
          <a href="/cart">
            <img v-if="cart.products.length > 0" class="cart-ico" src="/img/cart-ico.png" />
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="cartModal">
      <div v-bind:class="{'active': showCart}" class="modal modal-lg" id="modal-id">
        <span v-on:click="onHideCart" class="modal-overlay" aria-label="Close"></span>
        <div class="modal-container">
          <div class="modal-header">
            <span v-on:click="onHideCart" class="btn btn-clear float-right" aria-label="Close"></span>
            <div class="modal-title h5">
              <img class="cart-ico" src="/img/cart-ico.png" />
